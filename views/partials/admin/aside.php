 ...
 <aside class="w-64 bg-slate-800 text-white flex flex-col">
    ...
    <nav class="flex-grow">
        <ul class="space-y-2 p-4">
            <li><a href="<?php echo Helpers::admin_url('/') ?>" class="block px-4 py-2 rounded-md hover:bg-slate-700">Dashboard</a></li>
            <li><a href="<?php echo Helpers::admin_url('/manage-category/') ?>" class="block px-4 py-2 rounded-md hover:bg-slate-700">category</a></li>
